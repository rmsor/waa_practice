...
public class ProductListWindow extends javax.swing.JWindow implements ParentWindow {
    ...
    private CustomTableModel model;
 	 ...
 	 * @param bsController 
 	 */
	public ProductListWindow(String type, BrowseSelectController bsCont) {
		this.catalogType = type;
		this.bsController = bsCont;
	 ...
	 * being used, then the data should come from the controller
	 */
	private void updateModel() {
        ...
        theData = bsController.getProductNameStringArrays(catalogType);
	...
	*/
	...
	class SelectButtonListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent evt) {
        	...
        	if(selectedRow >= 0) {
        		...
        		/* to make this work with business objects, replace the next 2 lines
        		 *   --use the controller to get a string array of the product paramters,
        		 *     instead of these 2 lines
        		 */
        		//HashMap<String,String[]> productTable = readProductDetailsData();
        		//String[] productParams = productTable.get(type);
        		String[] productParams = bsController.getProductParameters(type); 
        		//System.out.println("Is product params an instance of Object[]? "+(productParams instanceof Object[]));
        		ProductDetailsWindow pd =  new ProductDetailsWindow(productParams, bsController);
	...
	public static void main(String args[]) {
		...
		/* should only be used with dummy data--"null" controller kl 9/16/07 */
		(new ProductListWindow("Clothes", null)).setVisible(true);
	}
	/**
	 * 
	 */
