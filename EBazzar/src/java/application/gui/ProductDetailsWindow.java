...
public class ProductDetailsWindow extends JWindow implements ParentWindow {
	...
	public ProductDetailsWindow(String[] params, BrowseSelectController bsCont) {
		bsController = bsCont;
	...
	class AddToCartListener implements ActionListener {
        public void actionPerformed(ActionEvent evt) {
        	setVisible(false);
        	//Product prodToBuy = bsController.getProduct(item);
            QuantityWindow win = new QuantityWindow(bsController, item );  //TODO kl -- refactor:  should probably be sending along price too, and setting that as price the product object purchased
