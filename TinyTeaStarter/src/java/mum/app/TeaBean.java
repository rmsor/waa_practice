...
//                new TeaEntity("OOLONG", 12, 0)));
    ...
    /**
     * this is a jsf action method sideeffects: creates orders (i.e., order line
     * items) and stores in the orderList
     *
     * @return
     */
    public String order() {
    ...
    /**
     * jsf action method to clear the order and issue a redirect to go to the
     * index page
     *
     * @return
     */
